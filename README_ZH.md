...
| 包 | 描述 | 版本 |
|---|------|------|
| [laconic](https://pub.dev/packages/laconic) | 核心查询构建器 | 2.3.0 |
| [laconic_sqlite](https://pub.dev/packages/laconic_sqlite) | SQLite 驱动 | 1.3.0 |
| [laconic_mysql](https://pub.dev/packages/laconic_mysql) | MySQL 驱动 | 1.3.0 |
| [laconic_postgresql](https://pub.dev/packages/laconic_postgresql) | PostgreSQL 驱动 | 1.3.0 |
...
dependencies:
  laconic: ^2.3.0
  laconic_sqlite: ^1.3.0    # SQLite
  # laconic_mysql: ^1.3.0   # MySQL
  # laconic_postgresql: ^1.3.0  # PostgreSQL
```
