...
|---------|-------------|---------|
| [laconic](https://pub.dev/packages/laconic) | Core query builder | 2.0.0 |
| [laconic_sqlite](https://pub.dev/packages/laconic_sqlite) | SQLite driver | 1.0.0 |
| [laconic_mysql](https://pub.dev/packages/laconic_mysql) | MySQL driver | 1.0.0 |
| [laconic_postgresql](https://pub.dev/packages/laconic_postgresql) | PostgreSQL driver | 1.0.0 |
